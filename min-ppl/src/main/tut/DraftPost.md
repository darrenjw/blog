...
That's it! This is a complete, general-purpose, composable, monadic PPL. As presented, it's 52 lines of code. But that's 50 if we skip the 2 imports, or `cond`, or `fitQ`, or a standard distribution, or indeed put a couple of trailing `}` on the previous line. Let's now see how it works in practice.
